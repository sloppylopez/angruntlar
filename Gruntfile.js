...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        clean: {
            ...
            server: '.tmp',
            resized: '<%= config.app %>/images/resized'
        },
        ...
        jshint: {
            ...
            uses_defaults: [
                ...
                //'!<%= config.
                // app %>/scripts/{,*/}*rssFeederServiceFactory.js',
            ...
            //    },
            //    files: {
            //        src: ['Gruntfile.js', '<%= config.app %>/scripts/factories/rssFeederServiceFactory.js']
            //    }
            //}
        },
        ...
        //for not having to explicitly declare attributes for minification process
        ngAnnotate: {
            dist: {
                files: [{
                    expand: true,
